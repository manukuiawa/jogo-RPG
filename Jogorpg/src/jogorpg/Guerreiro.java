...
public class Guerreiro extends Personagem {
    ...
    public Guerreiro(String nome, int idade, int nivel, String descricao, int forca, int vitalidade, int destreza, int poder, String habilidade, String descHabilidade, int poderHabilidade, String porteFisico) {
